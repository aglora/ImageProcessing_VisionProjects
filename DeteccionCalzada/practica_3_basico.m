clear; clc; close all;
%% PRÁCTICA 3 BÁSICO:  SEGMENTACIÓN DE CALZADA EN IMAGEN AÉREA
%%
...
for fotograma = 260:790 %Leer y procesar de la misma manera los distintos fotogramas para probar robustez del algoritmo ante distintas situaciones
    ...
    %%
    if(thetaRectasFotograma(1)>0 && thetaRectasFotograma(2)>0) %comprobar si se ha detectado correctamente las líneas
...
porcentajeFallos=(fallosTotales/530)*100 %mostrar al final de ejecución % de fallos a lo largo de toda la secuencia de fallos
return;